...
-- keymap("n", "<M-o>", function() require("oil").toggle_float() end)
...
keymap("n", "<leader>uC", function() require("CopilotChat").toggle() end)
...
keymap("i", "<C-S-Space>", "<cmd>lua vim.lsp.buf.completion()<CR>")
