  ...
  { "tpope/vim-fugitive" },
  {
    ...
    opts = {
      ...
      on_attach = function(bufnr)
        ...
        -- Actions
        map("n", "<localleader>sh", gitsigns.stage_hunk)
        map("n", "<localleader>rs", gitsigns.reset_hunk)
        map("v", "<localleader>sh", function()
        ...
        -- map("n", "", gitsigns.toggle_word_diff)
