...
alias gnb='git checkout -b'  # Create and checkout a new branch
...
alias gld='git log --graph --pretty=format:"%C(yellow)%h%Creset - %C(bold blue)%an%Creset, %Cgreen%ar%Creset : %C(bold red)%s%Creset" --abbrev-commit'
